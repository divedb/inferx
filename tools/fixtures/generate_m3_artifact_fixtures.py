#!/usr/bin/env python3
"""Generate deterministic, deliberately tiny M3 artifact fixtures."""
...
FIXTURE_ROOT = ROOT / "tests" / "fixtures" / "m3"
...
def tiny_llama_files() -> dict[Path, bytes]:
    ...
    generated: dict[Path, bytes] = {
        ...
        Path("tiny_llama/tokenizer.json"): b"{}\n",
...
def main() -> int:
    ...
    if failures:
        print("M3 artifact fixtures are stale:")
