#!/usr/bin/env python3
"""Calculate CUDA benchmark percentiles and enforce paired wrapper overhead."""
...
def main() -> int:
    ...
    if failed:
        print("CUDA wrapper overhead exceeds 3% or evidence is incomplete", file=sys.stderr)
        return 1
    return 0
