# ADR 0025: tokenizer backend and concurrency
...
the artifact layer under ADR 0027; no tokenizer implementation is retained. `INFERX_ENABLE_TOKENIZATION` defaults off and fails configuration
